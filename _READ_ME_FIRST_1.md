...
**Two-page orientation (start here after this file):**
- `PAGE_1_THE_CANON.md` — the rules, the boundaries, how to triage findings
- `PAGE_2_THE_MAP.md` — where things are, how to access them, what to read next

Full culture and rules: `CHARTER/00-LIVING-CHARTER.md` → `CHARTER/01-WHO-WE-ARE.md` → `CHARTER/02-HOW-WE-WORK.md` → `CHARTER/03-BOUNDARIES.md`. Read them when you need depth.
