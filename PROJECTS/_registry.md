...
| Faith Through Physics Atom System | `https://github.com/YellowKidokc/Faith-through-physics-atoms` | Claim atoms, 14-stage workbench, controlled vocabulary, graph rules, templates, and validation | Branch `OBS-Plugin-Final-Claude`; `README.md`; `_docs/GOVERNING_RULES_FINAL.md`; `_vocab/` | architecture present; implementation incomplete | 2026-07-23 | repo and branch inspected; current validator run | Read `THEOPHYSICS/topics/atom-system-architecture.md` before changing architecture |
