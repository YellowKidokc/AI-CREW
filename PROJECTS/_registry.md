...
| AI Desktop Bridge / Command-Line Crew | `D:\GitHub\David-OS\ahk\overlay`; `D:\GitHub\David-OS\tools\ai-crew-cli` | Local human-to-AI routing layer: clean AutoHotkey overlay/API bridge for UI-only desktop targets, plus direct `codex exec` crew launcher for command-line agents | `PROJECTS/david-os/AI_DESKTOP_BRIDGE_OVERLAY_RESEARCH_20260726.md`; David-OS overlay/CLI files | active prototype; clean overlay and CLI under live testing | 2026-07-27 | files inspected and patched in David-OS this session | Use API/CLI directly when possible; use AHK overlay only for UI-only targets. Kimi path is unreliable; Codex/CMD path is priority |
...
| Faith Through Physics Atom System | `D:\GitHub\Faith-through-physics-atoms`, `https://github.com/YellowKidokc/Faith-through-physics-atoms` | Claim atoms, 14-stage workbench, controlled vocabulary, graph rules, templates, and validation | `PROJECTS/claim-atoms/STATUS.md`; `_docs/GOVERNING_RULES_FINAL.md`; `_vocab/vocab.json` | architecture strong; 24 domains scaffolded, 1 demo atom, 0 complete | 2026-07-26 | repo inspected; validator patched and run | Status-ceiling rule added 2026-07-26 — see `PROJECTS/claim-atoms/STATUS.md`. Read `THEOPHYSICS/topics/atom-system-architecture.md` before changing architecture |
